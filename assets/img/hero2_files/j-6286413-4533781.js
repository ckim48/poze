//Generated:2023-11-30 09:39:38// 6-274
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_6286413 || '',
    guid: window.ftGUID_6286413 || '',
    confID: window.ftConfID_6286413 || '0',
    ftReturn: window.ftReturn_6286413 || '',
    keyword: window.ftKeyword_6286413 || '',
    ftId: window.ftId_6286413 || '',
    ftImpId: window.ftImp6286413 && window.ftImp6286413.impID || '',
    gdpr: window.ftImp6286413 && window.ftImp6286413.gdpr || '',
    gdpr_consent: window.ftImp6286413 && window.ftImp6286413.gdpr_consent || '',
    gdpr_pd: window.ftImp6286413 && window.ftImp6286413.gdpr_pd || '',
    us_privacy: window.ftImp6286413 && window.ftImp6286413.us_privacy || '',
    campaignID: '115740',
    cID: '183076',
    pID: '6286413',
    creativeID: '4533781',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115740&sid=20050&plc=6286413&num=&adid=&advid=&adsrv=29&btreg=6286413&btadsrv=flashtalking&crt=4533781&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["https://servedby.flashtalking.com/click/8/115740;6286413;4533781;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/kr/creativecloud/buy/students.html?plan=edu&sdid=MC95SGBR&mv=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?226855726-6286413;4533781;',
    centreAd: false,
    width: 728,
    height: 90,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/628/6286413/4533781/image/4533781.gif',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/115740;6286413;202;pixel;QuantcastAdobeDyn;QuantcastFY22EDULALCLTV80100DynamicKRDSKBAN728x90/?',
    stump: 'https://servedby.flashtalking.com',
    altimghref: "https://servedby.flashtalking.com/click/8/115740;6286413;4533781;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/kr/creativecloud/buy/students.html?plan=edu&sdid=MC95SGBR&mv=display",
    divID: 'ftdiv6286413',
    altimgID: 'ftalt6286413',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp6286413 && parseInt(window.ftImp6286413.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m6286413') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m6286413'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_6286413").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_6286413").style.display = "none";
		    }
		});
	}
}(ft6286413));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115740&l2=QuantcastAdobeDyn&l3=6286413&l4=4533781&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115740&l2=QuantcastAdobeDyn&l3=6286413&l4=4533781&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_6286413;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_6286413;
